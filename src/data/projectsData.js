...
x:"48%",
y:"10%",
tech:["React","LLM","Supabase"],

description:
"Developed an AI-powered study platform that helps students generate summaries, flashcards, and quizzes from learning materials. Integrated LLMs and NLP pipelines to automate content understanding and improve personalized learning experiences.",
...
description:
"Designed and developed a scalable e-commerce platform using Angular, Spring Boot microservices, and MySQL. Implemented product browsing, cart management, search functionality, buyer workflows, and service-based architecture to simulate a real-world online marketplace.",

github:"https://github.com/akankshabolla/Microservices-Ecommerce-project",
...
description:
"Currently developing an AI-based video intelligence system using multiple deep learning architectures and ensemble techniques. The project explores action recognition and video understanding with an interactive analytics interface.",
